...
class CrisisNegotiator(gl.Contract):
    ...
    def take_action(self, action: int) -> int:
        ...
        prompt = f"""Score this disaster-response dispatch from 0 to 100.
State bucket: {old_state}. Action: {action}.
Reward efficient life-saving dispatch; penalize wasting scarce capacity.
