...
class ProtocolImmunologist(gl.Contract):
    ...
    def take_action(self, action: int) -> int:
        ...
        prompt = f"""Score this DAO treasury-defense action from 0 to 100.
Threat-regime bucket: {old_state}. Action: {action}.
Reward proportional protection during a real threat and restraint during noise.
